...
/* Objects */
const planeGeometry = new THREE.PlaneBufferGeometry(10, 10, 90, 90);

/* Shader */
// 引入着色器文件；
import vertexShader from "./shader/pattern/vertex.glsl";
import fragmentShader from "./shader/pattern/fragment.glsl";
// 引入纹理
